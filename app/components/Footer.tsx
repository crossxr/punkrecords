...
export default function Footer() {
  return (
    <footer className="w-full bg-obsidian text-paper pt-80 pb-48 px-24 md:px-48 border-t border-ash/10 mt-auto">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-40 pb-64 border-b border-ash/10">
        
        {/* Brand Block */}
        <div className="flex flex-col gap-16 md:col-span-2">
          <Link href="/" className="flex items-center gap-8 group w-fit">
            <div className="w-20 h-20 bg-lemon-zest rounded-full flex items-center justify-center relative overflow-hidden">
              <div className="w-6 h-6 bg-paper rounded-full absolute top-4 left-4" />
            </div>
            <span className="font-display text-subheading font-bold text-paper tracking-tight">
              punkrecords<span className="text-royal-violet">*</span>
            </span>
          </Link>
        ...
        <div className="flex flex-col gap-16">
          ...
          <ul className="flex flex-col gap-12 font-body text-[15px] text-slate">
            <li>
      ...
      <div className="max-w-[1200px] mx-auto pt-32 flex flex-col sm:flex-row items-center justify-between gap-16 font-body text-caption text-slate">
